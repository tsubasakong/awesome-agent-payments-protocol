...
- [SqueezeOS](https://github.com/Timwal78/squeezeos-api) — Institutional market-intelligence x402 endpoints (squeeze detection, options flow, IWM 0DTE signals) from Script Master Labs. Micropayment-gated on Base and XRPL, free-tier tools with no auth. `squeezeos-api.onrender.com/mcp`
