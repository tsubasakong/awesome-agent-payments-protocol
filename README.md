...
- [Veriton HTML→JSON](https://veriton-dev.github.io/veriton-micro-dev/api/) — Metered HTML→structured JSON for agents on **Base USDC** via **x402** ($0.02 extract / $0.05 fetch). Free demo, OpenAPI, `/.well-known/x402`. Live: [html-to-json](https://tue-alabama-married-wonder.trycloudflare.com/v1/html-to-json) (unpaid → HTTP 402).
