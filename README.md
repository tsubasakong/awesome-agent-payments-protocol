...
- [Basalt](https://basalt-n6lt.onrender.com) — 9 pay-per-call utility tools for AI agents (URL metadata, domain/email/SSL checks, HTML↔Markdown, QR generation, PDF text extraction, language detection, JSON Schema validation) over **x402**/USDC on Base. ([OpenAPI](https://basalt-n6lt.onrender.com/openapi.json))
