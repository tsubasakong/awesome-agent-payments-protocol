...
- [openai-agents-nano](https://github.com/PANDeveloper001/openai-agents-nano-x402) — Python x402 client for the OpenAI Agents SDK that pays self-custodied Nano (XNO) instead of USDC, via the MIT feeless402 client
