...
- [PitchPilot Outreach API](https://pitchpilot-outreach-api.pitchpilot-agents.workers.dev) — Pay-per-call email outreach toolkit for AI agents over **x402**: 12 micro-endpoints for cold-email deliverability audits, email grading, and template generation; USDC on Base, no signup or API keys. Hosted [MCP server](https://pitchpilot-mcp.pitchpilot-agents.workers.dev/mcp) (13 tools), [OpenAPI](https://pitchpilot-outreach-api.pitchpilot-agents.workers.dev/openapi.json), free previews (Sep 2026)
